...
def Index(request):
    ...
    return render(request,"mainproject/index.html",params)

def CreateView(request):

    return render(request,"mainproject/createForm.html")
...
def Search(request):
    ...
    return render(request,"mainproject/searchresult.html",params)

def contactUs(request):
    return render(request, "mainproject/contactUs.html",)
